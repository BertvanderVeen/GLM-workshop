...
In the last practical we used information criteria to compare binomial glms. In this practical we return to those models and try to figure out which model fits "best" to the data. For this you will need the following functions:
