...
If we fit our gamma regression, we see that the parameter estimates are close to the true values we used in the simulation (intercept = 1, x1 = -2, x2 = -0.5):
...
y3 <- t(sapply(1:30, function(i)rmultinom(1, 1, ps2[i,])))
...
3. [r6data](https://raw.githubusercontent.com/BertvanderVeen/GLM-workshop/refs/heads/main/data/R6data.csv): data of two plant species under low and high nitrate supply. Response is the proportion of biomass in roots ("RMF"), stems ("SMF"), and leaves ("LMF").
...
7. [wafer](https://raw.githubusercontent.com/BertvanderVeen/GLM-workshop/refs/heads/main/data/wafer.csv) in faraway: wafer resistivity. 
