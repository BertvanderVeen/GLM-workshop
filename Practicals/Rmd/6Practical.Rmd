...
5. Compare the change in probability from Q4 to the corresponding odds ratio from Q3. An odds ratio of 2 does not mean the probability doubles — why not? How does the effect of a predictor on the probability scale depend on the baseline probability?

6. How do the parameter estimates change when you switch from a logit to a probit link?

7. Plot the residuals of the model. How do they look? Can you discern any assumption violations?
