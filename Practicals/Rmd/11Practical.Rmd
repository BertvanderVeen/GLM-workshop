...
You can continue with the dataset from Practical 10, or pick a new one from the list below. You can find the datasets in the "data" folder of the github repository.
...
1. Continue with the dataset and model from Practical 10, or fit a new Poisson regression to one of the datasets above.

2. Plot the residuals using `plot` or a combination of `residuals` and `fitted`.

3. Plot Dunn-Smyth residuals with the `DHARMa` package. What do you conclude?
...
6. Plot the Dunn-Smyth residuals with the `DHARMa` package. Have things improved?
