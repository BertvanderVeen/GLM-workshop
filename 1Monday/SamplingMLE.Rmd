...
For such (binary) data: $y_i \sim Binom(\pi_i, n_{picks})$, with $p(orchid) = \pi_i$
...
\begin{equation}
\frac{\partial^2\log\{\mathcal{L}(\textbf{y};n_{picks})\}}{\partial\pi^2} = \sum \limits^{n_{times}}_{i=1} -\frac{y_i}{\pi^2}-\frac{n_{picks}-y_i}{(1-\pi)^2} 
\end{equation}
