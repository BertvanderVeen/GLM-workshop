...
\newtcolorbox{codebox}{enhanced,colback=shadecolor,colframe=orange,boxrule=.2pt, arc=0pt, width=\paperwidth, enlarge left by=-10mm, after skip=2pt}
\AtBeginSection{}
...
\NormalTok{n.fields }\OtherTok{\textless{}{-}} \DecValTok{50}\NormalTok{;n.picks}\OtherTok{=}\DecValTok{10}\NormalTok{;p.orchid }\OtherTok{\textless{}{-}} \FloatTok{0.4}
\NormalTok{y }\OtherTok{\textless{}{-}} \FunctionTok{rbinom}\NormalTok{(n.fields, }\AttributeTok{size =}\NormalTok{ n.picks, }\AttributeTok{prob =}\NormalTok{ p.orchid) }
\end{Highlighting}
\end{Shaded}
...
\pandocbounded{\includegraphics[keepaspectratio]{IntroLM_files/IntroLM_files/figure-beamer/unnamed-chunk-2-1.pdf}}
\column{0.5\textwidth}
\pandocbounded{\includegraphics[keepaspectratio]{IntroLM_files/grassland.jpeg}}
\columnsend
\end{frame}
...
\begin{Highlighting}[]
\FunctionTok{set.seed}\NormalTok{(}\DecValTok{12345}\NormalTok{) }\CommentTok{\# For reproducibility}
\NormalTok{n.fields }\OtherTok{\textless{}{-}} \DecValTok{100}\NormalTok{;n.picks}\OtherTok{=}\DecValTok{1}\NormalTok{;p.orchid }\OtherTok{\textless{}{-}} \FloatTok{0.4}
\NormalTok{y }\OtherTok{\textless{}{-}} \FunctionTok{rbinom}\NormalTok{(n.fields, }\AttributeTok{size =}\NormalTok{ n.picks, }\AttributeTok{prob =}\NormalTok{ p.orchid) }
\end{Highlighting}
\end{Shaded}
...
\pandocbounded{\includegraphics[keepaspectratio]{IntroLM_files/IntroLM_files/figure-beamer/unnamed-chunk-4-1.pdf}}
\column{0.5\textwidth}
\pandocbounded{\includegraphics[keepaspectratio]{IntroLM_files/grassland.jpeg}}
\columnsend
\end{frame}
...
\pandocbounded{\includegraphics[keepaspectratio]{IntroLM_files/IntroLM_files/figure-beamer/unnamed-chunk-5-1.pdf}}
\end{frame}
...
\pandocbounded{\includegraphics[keepaspectratio]{IntroLM_files/normal.jpeg}}
\columnsend
\end{frame}
...
\log\{f(y_i;\mu, \sigma)\} = -\frac{1}{2}\log(2\pi\sigma^2) -\frac{(y_i-\mu)^2}{2\sigma^2}
...
It is a quadratic function of \(y_i\) so is \(\chi^2\)-distributed.
\end{frame}
...
\pandocbounded{\includegraphics[keepaspectratio]{IntroLM_files/IntroLM_files/figure-beamer/unnamed-chunk-6-1.pdf}}
\end{frame}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{IntroLM_files/alaskapipeline.jpg}}
...
\begin{frame}[fragile]{Alaska pipeline: t-test}
\phantomsection\label{alaska-pipeline-t-test}
\begin{codebox}
...
\begin{frame}[fragile]{Alaska pipeline: t-test output}
\phantomsection\label{alaska-pipeline-t-test-output}
\small
...
\pandocbounded{\includegraphics[keepaspectratio]{IntroLM_files/IntroLM_files/figure-beamer/unnamed-chunk-11-1.pdf}}
\end{frame}
...
\pandocbounded{\includegraphics[keepaspectratio]{IntroLM_files/xy.png}}
...
We measure data \(y_i\) and want to infer its relationship with \(x_i\)
...
\pandocbounded{\includegraphics[keepaspectratio]{IntroLM_files/IntroLM_files/figure-beamer/unnamed-chunk-12-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{IntroLM_files/IntroLM_files/figure-beamer/unnamed-chunk-13-1.pdf}}
...
\begin{frame}{Alaska pipeline: t-test as linear regression}
\phantomsection\label{alaska-pipeline-t-test-as-linear-regression}
\[
depth_i =
  \begin{cases}
...
\begin{frame}[fragile]{Alaska pipeline: t-test with \texttt{lm()}}
\phantomsection\label{alaska-pipeline-t-test-with-lm}
\tiny
...
\pandocbounded{\includegraphics[keepaspectratio]{IntroLM_files/IntroLM_files/figure-beamer/reg-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{IntroLM_files/IntroLM_files/figure-beamer/reg2-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{IntroLM_files/IntroLM_files/figure-beamer/norm2-1.pdf}}
\end{frame}

\begin{frame}{How good is the line?}
\phantomsection\label{how-good-is-the-line}
\pandocbounded{\includegraphics[keepaspectratio]{IntroLM_files/IntroLM_files/figure-beamer/norm-1.pdf}}
...
\end{equation} which is the same as maximizing the normal likelihood!
