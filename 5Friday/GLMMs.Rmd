...
$$
However, we are really interested in $\boldsymbol{u}\vert\textbf{y}$ instead; this holds information from our data!
...
- Information criteria do not work "on the boundary"
...
\begin{center}
\textcolor{red}{Focus on estimates (effect sizes) and statistical uncertainty}
\end{center}
